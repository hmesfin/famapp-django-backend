...
from apps.shared.models import UUIDMixin, TimestampedMixin
...
class User(UUIDMixin, TimestampedMixin, AbstractUser):
    ...
    email_verified = BooleanField(_("email verified"), default=False, help_text=_("Designates whether this user has verified their email address."))
    ...
    def get_active_roles(self):
        ...
        return [ur.role for ur in self.user_roles.filter(is_active=True) if ur.is_valid()]
    ...
    def grant_permission(self, permission, resource=None, granted_by=None, expires_at=None, context=None):
        """
