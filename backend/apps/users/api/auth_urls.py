...
urlpatterns = [
    ...
    path("login-custom/", auth_views.CustomTokenObtainPairView.as_view(), name="token_obtain_pair_custom"),  # Alias for frontend compatibility
    ...
    path("permissions/", auth_views.available_permissions, name="available_permissions"),
    ...
    path("reset-password/", auth_views.reset_password_confirm, name="reset_password_confirm"),
    
    # Email verification endpoints
    path("verify-email/", auth_views.verify_email, name="verify_email"),
    path("resend-verification/", auth_views.resend_verification_email, name="resend_verification"),
]