...
class PermissionModelTest(TestCase):
    ...
    def test_permission_unique_code_name(self):
        ...
        Permission.objects.create(code_name="test_permission", name="Test Permission 1")

        with self.assertRaises(Exception):
            Permission.objects.create(
                code_name="test_permission", name="Test Permission 2"
            )
...
class RoleModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.permission1 = Permission.objects.create(
            code_name="perm1", name="Permission 1"
        )
        self.permission2 = Permission.objects.create(
            code_name="perm2", name="Permission 2"
        )

    def test_role_creation(self):
        """Test creating a role."""
        role = Role.objects.create(
            code_name="test_role", name="Test Role", description="A test role"
        )
    ...
    def test_role_permissions(self):
        ...
        role = Role.objects.create(code_name="test_role", name="Test Role")
...
class UserRBACTest(TestCase):
    ...
    def setUp(self):
        ...
        self.permission1 = Permission.objects.create(
            code_name="view_content", name="View Content"
        )
        self.permission2 = Permission.objects.create(
            code_name="edit_content", name="Edit Content"
        )

        self.role = Role.objects.create(code_name="editor", name="Editor")
    ...
    def test_user_direct_permission(self):
        ...
        permission = Permission.objects.create(
            code_name="special_permission", name="Special Permission"
        )
    ...
    def test_user_permission_revocation(self):
        ...
        permission = Permission.objects.create(
            code_name="revokable_permission", name="Revokable Permission"
        )
    ...
    def test_expired_role_assignment(self):
        ...
        user_role = self.user.assign_role(self.role, expires_at=past_time)
    ...
    def test_get_active_roles(self):
        ...
        role2 = Role.objects.create(code_name="manager", name="Manager")
    ...
    def test_get_all_permissions(self):
        ...
        direct_permission = Permission.objects.create(
            code_name="direct_perm", name="Direct Permission"
        )
...
class ResourcePermissionTest(TestCase):
    ...
    def setUp(self):
        ...
        self.permission = Permission.objects.create(
            code_name="edit_article", name="Edit Article"
        )

        self.resource = Resource.objects.create(
            resource_type="article", resource_id="123", name="Test Article"
        )
    ...
    def test_resource_specific_permission(self):
        ...
        other_resource = Resource.objects.create(
            resource_type="article", resource_id="456", name="Other Article"
        )
        self.assertFalse(self.user.has_permission("edit_article", other_resource))
        self.assertFalse(
            self.user.has_permission("edit_article")
