...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        permissions_data = [
            ...
            (PermissionCodeName.SEND_INVITATIONS, 'Send Invitations', 'Can send invitations to new users', 'invitations'),
            (PermissionCodeName.VIEW_ALL_INVITATIONS, 'View All Invitations', 'Can view all invitations in the system', 'invitations'),
            (PermissionCodeName.MANAGE_INVITATIONS, 'Manage Invitations', 'Can manage (resend, cancel) all invitations', 'invitations'),
            
            # User management
            (PermissionCodeName.MANAGE_USERS, 'Manage Users', 'Can create, edit, and delete users', 'users'),
            (PermissionCodeName.VIEW_ALL_USERS, 'View All Users', 'Can view all users in the system', 'users'),
            (PermissionCodeName.EDIT_USER_ROLES, 'Edit User Roles', 'Can assign and modify user roles', 'users'),
            
            # Project permissions
            (PermissionCodeName.CREATE_PROJECTS, 'Create Projects', 'Can create new projects', 'projects'),
            (PermissionCodeName.EDIT_ALL_PROJECTS, 'Edit All Projects', 'Can edit any project', 'projects'),
            (PermissionCodeName.DELETE_PROJECTS, 'Delete Projects', 'Can delete projects', 'projects'),
            (PermissionCodeName.VIEW_ALL_PROJECTS, 'View All Projects', 'Can view all projects', 'projects'),
            
            # General permissions
            (PermissionCodeName.ACCESS_ADMIN_PANEL, 'Access Admin Panel', 'Can access the Django admin panel', 'admin'),
            (PermissionCodeName.VIEW_ANALYTICS, 'View Analytics', 'Can view system analytics and reports', 'analytics'),
            (PermissionCodeName.MANAGE_SETTINGS, 'Manage Settings', 'Can manage system settings', 'settings'),
        ]
