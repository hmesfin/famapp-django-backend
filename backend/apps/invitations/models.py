...
class Invitation(BaseModel):
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['status', 'is_deleted']),  # For active() + status filtering
            models.Index(fields=['invited_by', 'status', 'is_deleted']),  # For user's invitations
            ...
            models.Index(fields=['email', 'status', 'is_deleted']),  # For email existence checks
            models.Index(fields=['status', 'accepted_at']),  # For acceptance time calculations
