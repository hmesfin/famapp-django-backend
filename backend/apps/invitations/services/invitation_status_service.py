...
class InvitationStatusService:
    ...
    RESENDABLE_STATUSES = ['pending']  # Only pending invitations can be resent (original behavior)
    ...
    def get_status_summary(self, invitation: Invitation) -> Dict:
        ...
        if invitation.accepted_at:
            ...
            summary['accepted_by'] = invitation.accepted_by.email if invitation.accepted_by else None
