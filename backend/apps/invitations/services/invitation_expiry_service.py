...
class InvitationExpiryService:
    ...
    def extend_expiry(self, invitation: Invitation, days: int, user: User) -> Dict[str, Any]:
        """
    ...
    def bulk_extend_expiry(self, invitation_ids: list, days: int, user: User) -> Dict[str, Any]:
        """
    ...
    def get_expiry_summary(self, user: User = None) -> Dict[str, Any]:
        ...
        expiring_today = base_queryset.filter(
