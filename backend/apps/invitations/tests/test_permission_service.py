...
class TestPermissionService(TestCase):
    ...
    def test_can_send_invitations_permission(self):
        ...
        def permission_side_effect(user, perm_name):
            if user == self.regular_user and perm_name == PermissionCodeName.SEND_INVITATIONS:
                return True
            return False
            
        self.service._user_has_role = MagicMock(return_value=False)  # No roles
        self.service._user_has_permission = MagicMock(side_effect=permission_side_effect)
    ...
    def test_can_manage_all_invitations_manager_denied(self):
        ...
        self.service._user_has_permission = MagicMock(return_value=False)  # No manage permission
    ...
    def test_can_manage_all_invitations_permission(self):
        ...
        def permission_side_effect(user, perm_name):
            if user == self.regular_user and perm_name == PermissionCodeName.MANAGE_INVITATIONS:
                return True
            return False
    ...
    def test_can_manage_invitation_owner(self):
        ...
        result = self.service.can_manage_invitation(self.regular_user, self.regular_user)
        self.assertTrue(result)
    ...
    def test_can_manage_invitation_regular_user_other_user_denied(self):
        ...
        result = self.service.can_manage_invitation(self.regular_user, self.manager_user)
        self.assertFalse(result)
    ...
    def test_has_admin_role(self):
        ...
        self.assertTrue(result)
        self.service._user_has_role.assert_called_with(self.admin_user, RoleCodeName.ADMIN)
    ...
    def test_can_manage_invitation_with_none_users(self):
        ...
        self.service._user_has_role = MagicMock(return_value=False)  # No admin role for regular user
        self.service._user_has_permission = MagicMock(return_value=False)
