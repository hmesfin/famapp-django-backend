...
class TestEmailTemplateService(TestCase):
    ...
    def test_render_invitation_email_success(self):
        ...
        with patch('apps.invitations.services.email_template_service.render_to_string') as mock_render:
    ...
    def test_send_invitation_email_success(self):
        ...
        with patch.object(EmailTemplateService, 'render_invitation_email') as mock_render:
            ...
            with patch('apps.invitations.services.email_template_service.EmailMultiAlternatives') as mock_email:
                mock_message = Mock()
    ...
    def test_send_simple_reminder_success(self):
        ...
        with patch('apps.invitations.services.email_template_service.send_mail') as mock_send:
    ...
    def test_validate_templates_exist(self):
        ...
        with patch('apps.invitations.services.email_template_service.get_template') as mock_get:
    ...
    def test_urgency_level_calculation(self):
        ...
        with patch('apps.invitations.services.email_template_service.render_to_string') as mock_render:
            ...
            EmailTemplateService.render_invitation_email(self.invitation, EmailType.REMINDER)
            context = mock_render.call_args_list[0][0][1]
            self.assertEqual(context['urgency_level'], 'critical')
    ...
    def test_email_types_enum_coverage(self):
        ...
        supported_types = [EmailType.INVITATION, EmailType.REMINDER, EmailType.WELCOME, EmailType.EXPIRY_NOTICE]
