...
class InvitationAPITests(APITestCase):
    ...
    def test_list_invitations_sent(self):
        ...
        Invitation.objects.create(email="user1@example.com", invited_by=self.inviter)
        Invitation.objects.create(email="user2@example.com", invited_by=self.inviter)
    ...
    def test_accept_invitation_api(self):
        ...
        invitation = Invitation.objects.create(
            email="newuser@example.com", invited_by=self.inviter, role="member"
        )
    ...
    def test_user_can_only_see_own_invitations(self):
        ...
        Invitation.objects.create(email="invite1@example.com", invited_by=self.inviter)

        # Create invitation as other user
        Invitation.objects.create(
            email="invite2@example.com", invited_by=self.other_user
        )
