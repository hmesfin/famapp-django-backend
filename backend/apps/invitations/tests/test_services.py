...
class BulkInvitationServiceTest(TestCase):
    ...
    def test_get_bulk_invitation_summary(self):
        ...
        result = {
            'successful': [{'email': 'test1@example.com'}, {'email': 'test2@example.com'}],
...
class InvitationStatsServiceTest(TestCase):
    ...
    def test_get_pending_count_admin(self):
        ...
        self.service.permission_service.can_view_all_invitations = MagicMock(return_value=True)
    ...
    def test_get_pending_count_regular_user(self):
        ...
        self.service.permission_service.can_view_all_invitations = MagicMock(return_value=False)
